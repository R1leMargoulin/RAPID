...
ENV_IMAGE_PATH = "/home/erwan/Documents/tests_simulations/Pygame/test_500_500.png"
...
def main():
    env = Environment(background_color= BACKGROUND_COLOR, width= SCREEN_WIDTH, height=SCREEN_HEIGHT)
